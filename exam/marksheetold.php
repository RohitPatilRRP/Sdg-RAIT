...
<center>
     ...
     Seat no <input type="text" class="form-control" name='seatno' placeholder="Enter Seat Number"  required >
   </center>
<br>
   <center>
  
     Year of passing<input type="text" class="form-control" name='year' placeholder="Year of Passing (November 2013)" value="<?php echo $year;?>" required >
   </center>
   <br>
   <?php
